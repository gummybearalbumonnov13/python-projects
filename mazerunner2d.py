"""Maze Runner 2D, by Al Sweigart al@inventwithpython.com Move around a maze and try to escape. Maze files are generated by mazemakerrec.py. View this code at https://nostarch.com/big-book-small-python-projects Tags: large, game, maze"""
...
print('''Maze Runner 2D, by Al Sweigart al@inventwithpython.com (Maze files are generated by mazemakerrec.py)''')
